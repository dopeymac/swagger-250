...
public class PetStoreResource {
	...
	@ApiOperation(value = "Find purchase order by ID", notes = "For valid response try integer IDs with value <= 5 or > 10. "
			+ "Other values will generated exceptions", response = com.wordnik.swagger.sample.model.Order.class)
	...
	@POST
	@Path("/order")
	@ApiOperation(value = "Place an order for a pet", response = com.wordnik.swagger.sample.model.Order.class)
